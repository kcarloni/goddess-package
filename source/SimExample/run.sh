...
#--- program options to be specified: ---#
  ...
  TwinTileReflectorMaterialPropertiesName="TwinTileReflector_Aluminum.properties"
...
if [ "$SIMDIR" == "" ]; then
  echo
  echo "The environment variable \"SIMDIR\" has not been specified! It should point to the folder containing \"macros\" and \"MaterialProperties\"."
  echo
...
$BUILDDIR/SimExample $InitFileString